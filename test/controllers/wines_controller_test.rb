...
class WinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wine" do
    assert_difference('Wine.count') do
      post wines_url, params: { wine: { assembly: @wine.assembly, name: @wine.name, year: @wine.year } }
    end
  ...
  test "should update wine" do
    patch wine_url(@wine), params: { wine: { assembly: @wine.assembly, name: @wine.name, year: @wine.year } }
